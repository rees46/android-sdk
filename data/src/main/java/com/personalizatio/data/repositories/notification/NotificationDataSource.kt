...
class NotificationDataSource @Inject constructor(
    ...
    private fun getType(): String? = preferencesDataSource.getValue(SOURCE_TYPE_KEY, null)
    internal fun saveType(value: String) = preferencesDataSource.saveValue(SOURCE_TYPE_KEY, value)

    private fun getId(): String? = preferencesDataSource.getValue(SOURCE_ID_KEY, null)
    internal fun saveId(value: String) = preferencesDataSource.saveValue(SOURCE_ID_KEY, value)

    private fun getTime(): Long = preferencesDataSource.getValue(SOURCE_TIME_KEY, 0L)
